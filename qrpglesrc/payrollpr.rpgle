       ctl-opt Dftactgrp(*no);
        ...
        // ***********************************************************
        //   SUBROUTINES USED
        //   ValidateFileToMaintainSelection - Edit application selection displa
       ...
       Dcl-Proc EmployeeMaintenance;
        ...
        Dcl-Proc isAddPreviouslyDeletedRecordRequest;
          Dcl-Pi *n ind End-Pi;
          Return  ACODE = 'A' and not *IN50 and ACREC = 'D';
        End-Proc;

        // *******************************************************
        //   ValidateFileToMaintainSelection procedure verifies the time reporti
        ...
        //
        // *******************************************************
        //   ValidateActionCode procedure verifies the time reporting action cod
       ...
       *IN90 = *OFF;
       ...
       EndSl;
        ...
        DisplayError(5);
        Else;
        // record found but previously deleted - warning
